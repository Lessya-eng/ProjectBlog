...
export const sendLoginDataAction = createAction(
    ACTIONS.SEND_LOGIN_DATA_ACTION
)<IUserLoginAuth>();

export const sendLoginDataErrorAction = createAction(
    ACTIONS.SEND_LOGIN_DATA_ERROR_ACTION
)<string | null>();

export const sendLoginDatasSuccessAction = createAction(
    ACTIONS.SEND_LOGIN_DATA_SUCCESS_ACTION
)<boolean>();
