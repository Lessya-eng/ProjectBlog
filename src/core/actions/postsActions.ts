...
export const setPostsAction = createAction(
    ACTIONS.SET_POSTS_ACTION
)<IPost[] | null>();

export const setMyPostsAction = createAction(
    ACTIONS.SET_MY_POSTS_ACTION
)<IPost[] | null>();

export const getPostsAction = createAction(
    ACTIONS.GET_POSTS_ACTION
)();

export const getMyPostsAction = createAction(
